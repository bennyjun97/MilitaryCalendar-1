...
class LargeWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        mAppWidgetText.setText(loadTitlePref(this@LargeWidgetConfigureActivity, mAppWidgetId))
    }

    companion object {

        private val PREFS_NAME = "com.kyminbb.militarycalendar.activities.widget.LargeWidget"
